...
6. Se rend compte que l'appel à echo dans ./level03 se fait sans chemin absolu -> env lance le premier echo trouvé dans le $PATH du env
7. Mission Hijack the PATH

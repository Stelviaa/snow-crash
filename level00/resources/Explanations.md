...
4. Je l'essaie en mdp, cela ne marche pas, je le met donc dans dcode pour voir les differentes possibilite de chiffrement, le chiffrement ROT me renvoie ``nottoohardhere``, j'ai trouve le mot de passe. 